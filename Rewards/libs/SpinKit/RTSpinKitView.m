...
-(void) reload
{
    for(CALayer *alayer in self.animationLayers)
    {
    ...
    if (self.style == RTSpinKitViewStylePlane)
    {
        ...
        [self.animationLayers addObject:plane];
    ...
    else if (self.style == RTSpinKitViewStyleBounce)
    {
        ...
        for (NSInteger i=0; i < 2; i+=1)
        {
            ...
            [self.animationLayers addObject:circle];
            
            [circle addAnimation:anim forKey:@"spinkit-anim"];
        }
    }
    else if (self.style == RTSpinKitViewStyleWave) {
    ...
    else if (self.style == RTSpinKitViewStyleWanderingCubes)
    {
        NSTimeInterval beginTime = CACurrentMediaTime();
        CGFloat cubeSize = floor(CGRectGetWidth(self.bounds) / 4.0);
        ...
        for (NSInteger i=0; i<2; i+=1) {
            ...
            [self.animationLayers addObject:cube];

            [cube addAnimation:anim forKey:@"spinkit-anim"];
        }
    }
    else if (self.style == RTSpinKitViewStylePulse)
    {
        NSTimeInterval beginTime = CACurrentMediaTime();
