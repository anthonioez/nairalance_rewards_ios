...
{    
    open var forceVertical = false;
    static var titleFont: UIFont! = UIFont.boldSystemFont(ofSize: 16);
    static var titleColor: UIColor! = UIColor.black;
    
    static var bodyFont: UIFont! = UIFont.systemFont(ofSize: 14);
    static var bodyColor: UIColor! = UIColor.darkGray;
    
    static var buttonFont: UIFont! = UIFont.systemFont(ofSize: 14);
    static var buttonColorActive: UIColor! = UIColor.darkGray;
    static var buttonColorDefault: UIColor! = UIColor.lightGray;
    ...
    @IBOutlet weak open var alertActionStackView: TZStackView!
    @IBOutlet weak open var alertStackViewHeightConstraint: NSLayoutConstraint!
    
    open var ALERT_STACK_VIEW_HEIGHT : CGFloat = UIScreen.main.bounds.height < 568.0 ? 40 : 52 //if iphone 4 the stack_view_height is 40, else 62
    ...
    @objc public convenience init(title: String, description: String, image: UIImage?, style: PMAlertControllerStyle)
    {
        ...
        alertActionStackView.alignment = .center
        //alertActionStackView.axis = .vertical
        //alertActionStackView.spacing = 25
        ...
        alertStackViewHeightConstraint.constant = 20;
    }
    ...
    override open func viewWillAppear(_ animated: Bool)
    {
        ...
        alertTitle.textColor = PMAlertController.titleColor
        alertTitle.font = PMAlertController.titleFont;
        
        alertDescription.textColor = PMAlertController.bodyColor;
        alertDescription.font = PMAlertController.bodyFont;
    }
    ...
    @objc open func addAction(_ alertAction: PMAlertAction)
    {
        ...
        if alertActionStackView.arrangedSubviews.count > 2 || hasTextFieldAdded() || forceVertical
        {
        ...
        alertAction.titleLabel?.font = PMAlertController.buttonFont;
        alertAction.actionStyle == PMAlertActionStyle.default ? (alertAction.setTitleColor(PMAlertController.buttonColorActive, for: UIControlState())) : (alertAction.setTitleColor(PMAlertController.buttonColorDefault, for: UIControlState()))
    }
    ...
    @objc open func addTextField(_ configuration: (_ textField: UITextField?) -> Void)
    {
        ...
        textField.font = UIFont.systemFont(ofSize: 17) //TODO
